...
Promise.all([
  ...
  d3.csv("data_centres_socio_sportifs.csv", d => ({
    region: d.region || "",
    province: d.province || "",
    milieu: d.milieu || "",
  ...
  function showRegionPopup(regionName, fullDataset) {
    ...
    const visualizations = [
      ...
      {
        title: "Types de centres socio-sportifs",
        subtitle: "Analyse de la distribution des types de centres",
